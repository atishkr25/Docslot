...
const Footer = () => {
  ...
  <img className="w-28 mt-1" src={"/brand/docslot.svg"} alt="Docslot Logo" />
  <p className="text-gray-600 leading-6 md:max-w-[75%]">
    <strong>Docslot – Effortless Healthcare Scheduling
        ...
        <div>
          ...
          <ul className="flex flex-col gap-2 text-gray-600">
            ...
            <li>customersupport@docslot.in</li>
          </ul>
        </div>
      </div>
      ...
      <p className="py-4 text-sm text-center text-gray-600">
        © {new Date().getFullYear()} docslot.in — All Rights Reserved.
      </p>
    </div>
  );
};
